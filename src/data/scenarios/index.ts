...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    probabilityTier: 'very-high',
    probabilityLabel: 'Most common in winter — gas appliances, attached garages, and generators',
    summary: 'Carbon monoxide (CO) is odorless and colorless. It kills quickly and without warning. Any gas-burning appliance — furnace, water heater, range, generator — can produce CO when malfunctioning or when ventilation is blocked. Attached garages are a major risk even when not running a car.',
    sourceNote: 'Source: Centers for Disease Control and Prevention (CDC) / CPSC',
    trigger: [
      'CO detector alarm activates',
      'Multiple people in the home have simultaneous headache, dizziness, or nausea',
      'Pets acting confused or lethargic for no apparent reason',
      'Generator running indoors or in attached garage',
    ],
    immediateSteps: [
      { text: 'Activate alarm — shout "CO ALARM, GET OUT" if others are in the home.', critical: true },
      { text: 'Get everyone — including pets — outside immediately. Do not stop to gather belongings.', critical: true },
      { text: 'Leave the door open behind you to help ventilate.', critical: true },
      { text: 'Call 911 from outside. Do not go back inside until cleared by fire department.', critical: true },
      { text: 'If anyone is unresponsive or severely symptomatic: call 911 immediately and do not move them — wait for paramedics.' },
      { text: 'Seek fresh air immediately — even mild symptoms can worsen rapidly.' },
    ],
    extendedSteps: [
      { text: 'Do not re-enter until the fire department has identified the source and declared it safe.' },
      { text: 'Common sources: cracked heat exchanger in furnace, blocked flue or chimney, generator running in garage, charcoal grill indoors, car warming up in attached garage.' },
      { text: 'Anyone with symptoms should be evaluated at an emergency room — CO binds to hemoglobin and may require oxygen therapy.' },
      { text: 'Have your HVAC system and gas appliances inspected before returning.' },
      { text: 'If home is uninhabitable: activate rally protocol and go to your cluster hub.' },
    ],
    rallyTrigger: 'Home is unsafe after CO event or source cannot be identified. Go to cluster hub.',
    commsProtocol: [
      'Call 911 immediately from outside.',
      'Contact out-of-state coordinator once everyone is safely out.',
    ],
    awareness: {
      earlySignals: [
        'Headache, dizziness, or nausea that clears when you go outside — classic CO symptom pattern',
        'Multiple family members sick simultaneously with flu-like symptoms (no fever)',
        'Pets acting confused, lethargic, or collapsing — animals are often affected first',
        'CO detector alarming — even if everyone feels fine, treat it as real',
      ],
      avoid: [
        'Running any generator indoors, in a garage, or within 20 feet of a window — CO kills within minutes at high concentrations',
        'Warming up a vehicle in an attached garage — even with the garage door open',
        'Using gas ranges, ovens, or charcoal grills for heat indoors',
        'Dismissing a CO alarm as a false alarm without investigating',
        'Going back inside to gather belongings',
      ],
      calibration: 'You cannot smell or see CO. If the detector goes off, it is real. CO detectors are required by Indiana law in homes with gas appliances. Replace them every 5–7 years — they degrade silently.',
    },
    personalizedFields: ['rallyAddress', 'pets'],
  },
  {
